...
var cnItems = {
    ...
    "3 out of 10 of items I have on display are relics": "我展出的 10 件物品中有 3 件是圣遗物",
    "Aardvark's Water Hand Flail": "土豚的水手连枷",
    "Again, that one is not for sale. But I am sure you'll find quite a few relics in the shop next time, if I had to guess I would say that": "再说一次，那个是非卖品。 但我相信下次你会在商店里发现不少圣遗物，如果我不得不猜测的话我会这么说",
    ...
    "Crimson": "赤红",
    "power for battle related benefits.": "战斗相关利益的力量。",
    "Boost relic merge absortion rate: +": "提升圣遗物融合吸收率：+",
    "Fight reward double chance: +": "双倍战斗奖励几率：+",
    "Artifact Battle stats multiplier: x": "神器战斗属性乘数：x",
    "Elemental Assault Training": "元素攻击训练",
    "Four Elements Fortress Drill": "四元素堡垒钻",
    "Practice Elemental Recovery": "实践元素恢复",
    "It is incredible to see your growth.": "看到你的成长真是令人难以置信。",
    "I can't believe you came this far with those awful battle rituals. I taught them to You as a joke, I can't believe You actually still use them 😂.": "我不敢相信你通过那些可怕的战斗仪式走到了这一步。 我教你这些是开玩笑的，我不敢相信你居然还在用它们😂。",
    "I expected You would try them a few times and then realise I was messing arround and look for something better.": "我预计你会尝试几次，然后意识到我搞砸了并寻找更好的东西。",
    "I really should punish your stupidity, but I feel like using those rituals all this time was punishment enough.": "我真的应该惩罚你的愚蠢，但我觉得一直使用这些仪式已经足够惩罚了。",
    "So instead I'll reward your perseverance by telling You some of the rituals I personally use.": "因此，我将通过告诉您一些我个人使用的仪式来奖励您的毅力。",
    "Advanced battle rituals": "高级战斗仪式",
    "": "",
    "": "",
    "": "",
    "": "",
